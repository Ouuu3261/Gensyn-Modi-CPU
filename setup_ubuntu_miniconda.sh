...
echo_yellow "  2. 如果遇到 'conda init' 错误，请先运行: conda init bash && source ~/.bashrc"
echo_yellow "  3. 激活环境: conda activate rl-swarm"
echo_yellow "  4. 或使用快捷脚本: ./activate_rl_swarm.sh"
echo_yellow "  5. 运行项目: ./run_rl_swarm_fixed.sh"
echo_blue "======================================"
